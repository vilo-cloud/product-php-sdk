...
class InlineResponse2009 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'hydramember' => '\Vilo\ProductService\Model\TypeAttributeJsonldAttributeRead[]',
     ...
     * Sets hydramember
     *
     * @param \Vilo\ProductService\Model\TypeAttributeJsonldAttributeRead[] $hydramember hydramember
     *
     * @return self
     */
    ...
    public function setHydratotalItems($hydratotal_items)
    {
        ...
        if (!is_null($hydratotal_items) && ($hydratotal_items < 0)) {
            throw new \InvalidArgumentException('invalid value for $hydratotal_items when calling InlineResponse2009., must be bigger than or equal to 0.');
        }
