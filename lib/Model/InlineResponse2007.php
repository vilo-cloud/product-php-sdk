...
class InlineResponse2007 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'hydramember' => '\Vilo\ProductService\Model\AttributeSetJsonldRead[]',
     ...
     * Sets hydramember
     *
     * @param \Vilo\ProductService\Model\AttributeSetJsonldRead[] $hydramember hydramember
     *
     * @return self
     */
    ...
    public function setHydratotalItems($hydratotal_items)
    {
        ...
        if (!is_null($hydratotal_items) && ($hydratotal_items < 0)) {
            throw new \InvalidArgumentException('invalid value for $hydratotal_items when calling InlineResponse2007., must be bigger than or equal to 0.');
        }
