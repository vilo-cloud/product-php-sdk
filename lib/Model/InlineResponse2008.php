...
class InlineResponse2008 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'hydramember' => '\Vilo\ProductService\Model\OptionAttributeJsonldAttributeRead[]',
     ...
     * Sets hydramember
     *
     * @param \Vilo\ProductService\Model\OptionAttributeJsonldAttributeRead[] $hydramember hydramember
     *
     * @return self
     */
    ...
    public function setHydratotalItems($hydratotal_items)
    {
        ...
        if (!is_null($hydratotal_items) && ($hydratotal_items < 0)) {
            throw new \InvalidArgumentException('invalid value for $hydratotal_items when calling InlineResponse2008., must be bigger than or equal to 0.');
        }
