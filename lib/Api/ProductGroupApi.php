...
class ProductGroupApi
{
     ...
     *
     * @param  string $id Resource identifier (required)
     * @param  \Vilo\ProductService\Model\ProductGroup $product_group The updated ProductGroup resource (required)
     *
     * @throws \Vilo\ProductService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Vilo\ProductService\Model\ProductGroupJsonld
     */
    public function patchProductGroupItem($id, $product_group)
    {
        list($response) = $this->patchProductGroupItemWithHttpInfo($id, $product_group);
        return $response;
    }
     ...
     * @return array of \Vilo\ProductService\Model\ProductGroupJsonld, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchProductGroupItemWithHttpInfo($id, $product_group)
    {
        $request = $this->patchProductGroupItemRequest($id, $product_group);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchProductGroupItemAsync($id, $product_group)
    {
        return $this->patchProductGroupItemAsyncWithHttpInfo($id, $product_group)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchProductGroupItemAsyncWithHttpInfo($id, $product_group)
    {
        $returnType = '\Vilo\ProductService\Model\ProductGroupJsonld';
        $request = $this->patchProductGroupItemRequest($id, $product_group);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchProductGroupItemRequest($id, $product_group)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($product_group === null || (is_array($product_group) && count($product_group) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $product_group when calling patchProductGroupItem'
            );
        }
        ...
        if (isset($product_group)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($product_group));
            } else {
                $httpBody = $product_group;
            }
